...
```javascript
flatten4d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten4d@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-flatten4d/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/array-base-flatten4d/actions/workflows/test.yml?query=branch:v0.1.0
