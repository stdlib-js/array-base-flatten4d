...
```javascript
flatten4d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten4d@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/array-base-flatten4d/tags). For example,

```javascript
flatten4d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten4d@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var flatten4d = require( 'path/to/vendor/umd/array-base-flatten4d/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten4d@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/array-base-flatten4d/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/array-base-flatten4d/actions/workflows/test.yml?query=branch:v0.2.2
